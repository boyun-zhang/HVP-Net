...
class MSVD_DataLoader(RetrievalDataset):
    """MSVD dataset loader."""
    def __init__(self, subset, anno_path, video_path, tokenizer, max_words=32,
        ...
        super(MSVD_DataLoader, self).__init__(subset, anno_path, video_path, tokenizer, max_words,
    ...
    def _get_anns(self, subset='train'):
        ...
        caption_file = os.path.join(self.anno_path, "captions_msvd_small.json")
